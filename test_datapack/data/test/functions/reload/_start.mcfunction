...
data modify storage test:system stack_frame[-1].call_list[-1] append value {"value": "重载完成", "id": "None"}
#新建栈
...
#参数处理.赋值
#自定义函数调用
tellraw @a [{"nbt":"stack_frame[-1].call_list[-1][0].value","storage":"test:system"}]
##函数调用_end
