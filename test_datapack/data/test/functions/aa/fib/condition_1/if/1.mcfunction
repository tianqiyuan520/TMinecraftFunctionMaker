...
scoreboard players reset #test.system.c.1.1 input
...
execute if score #test.system.temp1 input <= #test.system.temp2 input run scoreboard players set #test.system.c.1.1 input 1
