...
execute unless score #test:system.stack.end input matches 1 run execute store result storage test:system main_tree[-1].exp_operation[-1].value double 0.001000000000 run scoreboard players operation #test.system.temp1 input += #test.system.temp2 input
