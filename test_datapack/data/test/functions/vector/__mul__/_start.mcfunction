...
execute unless score #test:system.stack.end input matches 1 run data modify storage test:system main_tree[-1].exp_operation append from storage test:system main_tree[-1].data[{"id":"self"}].value[{"id":"a"}]
execute unless score #test:system.stack.end input matches 1 run data modify storage test:system main_tree[-1].exp_operation append from storage test:system main_tree[-1].data[{"id":"other"}].value[{"id":"a"}]
...
execute unless score #test:system.stack.end input matches 1 run execute store result storage test:system main_tree[-1].exp_operation[-1].value double 0.000001000000 run scoreboard players operation #test.system.temp1 input *= #test.system.temp2 input
...
execute unless score #test:system.stack.end input matches 1 run data modify storage test:system main_tree[-1].exp_operation append from storage test:system main_tree[-1].data[{"id":"self"}].value[{"id":"b"}]
execute unless score #test:system.stack.end input matches 1 run data modify storage test:system main_tree[-1].exp_operation append from storage test:system main_tree[-1].data[{"id":"other"}].value[{"id":"b"}]
execute unless score #test:system.stack.end input matches 1 run execute store result score #test.system.temp1 input run data get storage test:system main_tree[-1].exp_operation[-2].value 1000
execute store result score #test.system.temp2 input run data get storage test:system main_tree[-1].exp_operation[-1].value 1000
execute unless score #test:system.stack.end input matches 1 run execute store result storage test:system main_tree[-1].exp_operation[-1].value double 0.000001000000 run scoreboard players operation #test.system.temp1 input *= #test.system.temp2 input
execute unless score #test:system.stack.end input matches 1 run data remove storage test:system main_tree[-1].exp_operation[-2]
...
execute unless score #test:system.stack.end input matches 1 run data remove storage test:system main_tree[-1].exp_operation[-1]
#新建栈
execute unless score #test:system.stack.end input matches 1 run data modify storage test:system main_tree append value {"data":[],"return":[],"exp_operation":[],"boolOPS":[],"for_list":[],"call_list":[],"call_list_":[],"list_handler":[],"dync":{}}
...
execute unless score #test:system.stack.end input matches 1 run data modify storage test:system main_tree[-1].data[{"id":"a"}].value set from storage test:system main_tree[-1].call_list[-1][0].value
execute unless score #test:system.stack.end input matches 1 run data modify storage test:system main_tree[-1].data[{"id":"b"}].value set from storage test:system main_tree[-1].call_list[-1][1].value
#类方法调用.初始化
...
execute unless score #test:system.stack.end input matches 1 run data modify storage test:system main_tree[-2].return append from storage test:system main_tree[-1].return[-1]
