...
execute unless score #test:system.stack.end input matches 1 run execute store result storage test:system data.exp_operation[-1].value double 0.000001000000 run scoreboard players operation #test.system.temp1 input *= #test.system.temp2 input
